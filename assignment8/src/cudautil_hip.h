...
static void PrintDeviceInfo(void){
	...
	std::cout << left<<setw(32)<< "MaxThreads per Block:"<<  			left<< setw(40)<< deviceProp.maxThreadsPerBlock <<std::endl;
	//std::cout << left<<setw(32)<< "Max Blocks per MP:"<<  			left<< setw(40)<< deviceProp.maxBlocksPerMultiProcessor <<std::endl;
	std::cout << left<<setw(32)<< "Available MPs:"<<  			left<< setw(40)<< deviceProp.multiProcessorCount <<std::endl;
	std::cout << left<<setw(32)<< "L2 __globaltimer size:"<<		left<< setw(3)<<"KB "<<left <<setw(37)<< deviceProp.l2CacheSize/1024<<std::endl;
